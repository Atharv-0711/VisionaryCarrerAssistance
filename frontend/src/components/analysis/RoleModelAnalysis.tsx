  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-xl font-semibold">Role Model Analysis</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="bg-purple-50 rounded-lg p-4">
            <h3 className="text-sm font-medium text-purple-800 mb-2">Impact Distribution</h3>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <h3 className="text-sm font-medium text-blue-800 mb-2">Key Metrics</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-gray-600">Influential Count</p>
                <p className="text-2xl font-semibold text-blue-600">{data.influentialCount}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Total Traits</p>
                <p className="text-2xl font-semibold text-blue-600">{data.totalTraits}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <h3 className="text-sm font-medium text-gray-800 mb-4">Top Traits</h3>
            ...
            {Object.entries(data.topTraits)
              ...
              .map(([trait, count], index) => (
                <div key={trait} className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-900">{trait}</p>
                    <p className="text-xs text-gray-500">{count} mentions</p>
                  </div>
                </div>
              ))}
          </div>
